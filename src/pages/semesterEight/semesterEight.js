...
class SemesterEight extends React.Component{
  ...
  render(){
    ...
    return (
        ...
        <PageNavigation nextPageText="Random" prevPageText="Semester 7" nextPageLink="random" prevPageLink="semester7"/>
      </div>
    );
  }
};

export default SemesterEight;
